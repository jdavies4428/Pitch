import {
  ...
  getPlayableCards, cardEquals, cardBeats, isWinningBid,
} from './game';
...
export function getAiBid(hand, currentHighBid, isDealer, allPassedToDealer, difficulty) {
  ...
  // Must take the lead; the dealer can only steal a bid of 4.
  if (bid > 0 && !isWinningBid(bid, currentHighBid, isDealer)) {
    bid = 0;
  }
